          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="/kajur/srtmsk">Surat Masuk<span class="badge bg-important">{{$request->data[0]}}</span></a></li>
                          <li><a class="" href="/kajur/statusurat">Persetujuan<span class="badge bg-important">{{$request->data[1]}}</span></a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          <li><a class="" href="/kajur/arsipsm">Surat Masuk</a></li>
                          <li><a class="" href="/kajur/arsipsk">Surat Keluar</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
